      ...
      <div class="panel-heading">
        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="username" value="{t}user{/t}" size="10" maxlength="20" required>
          </div>
          <div class="form-group">
            <label>{t}Worker Password{/t}</label>
            <input class="form-control" type="text" name="password" value="{t}password{/t}" size="10" maxlength="20" required>
          </div>
        </div>
