        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td>
                {capture assign=wallet_default_error}{t}None - OK{/t}{/capture}
                <a href="{$smarty.server.SCRIPT_NAME}?page=admin&action=wallet">{$WALLET_ERROR|default:$wallet_default_error}</a>
              </td>
            </tr>
          </tbody>
        </table>
