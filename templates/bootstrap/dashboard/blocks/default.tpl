...
{section block $BLOCKSFOUND}
            <tr>
              ...
              <td>
                  {if $BLOCKSFOUND[block].is_anonymous|default:"0" == 1 && $GLOBAL.userdata.is_admin|default:"0" == 0}
                        {t}anonymous{/t}
                  {else}
                        {capture assign=unknown_user}{t}unknown{/t}{/capture}
                        {$BLOCKSFOUND[block].finder|default:$unknown_user|escape}
                  {/if}
              </td>
