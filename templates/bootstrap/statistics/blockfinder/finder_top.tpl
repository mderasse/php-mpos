...
{capture assign=default_account}{t}unknown{/t}{/capture}
      <tr>
              <td>{$rank++}</td>
              <td>{if $BLOCKSSOLVEDBYACCOUNT[block].is_anonymous|default:"0" == 1 && $GLOBAL.userdata.is_admin|default:"0" == 0}{t}anonymous{/t}{else}{$BLOCKSSOLVEDBYACCOUNT[block].finder|default:$default_account|escape}{/if}</td>
