        ...
        <table class="table table-striped table-bordered table-hover">
          <tbody>
            ...
            <tr>
              ...
              {else}
              <td>{$NETWORK.EstNextDifficulty|number_format:"8"} ({t block_until_diff_change=$NETWORK.BlocksUntilDiffChange}Change in %1 Blocks{/t})</td>
              {/if}
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td id="b-target">{$ESTIMATES.shares|number_format:$GLOBAL.config.sharediffprecision} ({t}done{/t}: {$ESTIMATES.percent}%)</td>
            </tr>
